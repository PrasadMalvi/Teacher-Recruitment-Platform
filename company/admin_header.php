<?php $user_name=$_SESSION["uname"];?>
	 ...
	 <header class="app-header"><a class="app-header__logo" href="home.php"><img src="../jobseeker/images/logo.jpg" align="top" height="95%" width="100%"></a><b><font color="#FFFFFF"><br> <div class="header_right">&nbsp;&nbsp; Welcome <?php echo $user_name; ?></div></font></b>
