...
<html lang="en">
  ...
  <?php include('admin_header.php');?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-table"></i>&nbsp; Job Details</h1>
          <p>Details</p>
        </div>
  ...
  <table width="61%" height="210" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td><p>&nbsp;
        ...
        <p>
          <input name="jb_city" type="text" id="jb_city" value="<?php echo $row["jb_city"];?>" class="validate[required]">
        </p>
        <p>&nbsp;        </p></td>
    </tr>
    <tr>
      ...
      <td><p>&nbsp;
        ...
        <p>
          <input name="jb_state" type="text" id="jb_state" value="<?php echo $row["jb_pcode"];?>" class="validate[required]">
        </p>
        <p>&nbsp;        </p></td>
    </tr>
    <tr>
      ...
      <td><p>&nbsp;
        ...
        <p>
          <input name="jb_pcode" type="text" id="jb_pcode" value="<?php echo $row["jb_state"];?>" class="validate[required]">
</p>
        <p>&nbsp;        </p></td>
    </tr>
    <tr>
