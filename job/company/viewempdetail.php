...
<?php include('admin_side_bar.php');?>
    <main class="app-content" style="width:fit-content;">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Employee Details View</h1>
...
<?php
  ...
  $user=$_SESSION['uname'];
  $sql="select * from employee_details ed,job_seeker js,jobs j,job_application ja,company_details cd where ed.js_id=js.js_id and ed.jb_opening_id=j.jb_opening_id and ed.app_id=ja.app_id and ed.cmp_id=cd.cmp_id and cd.cmp_name='$user'";
