...
<div id="panelwrap">
    ...
    <h2>VIEW JOB DETAILS <a href="newjobs.php">New Jobs</a></h2> 
 ...
 ?>
  <tr>
    ...
    <td><a href="editjobs.php?jb_opening_id=
			...
			onclick ="return confirm('Are you sure? Want to Updated this Record')";><img src="images/edit.png" width="26" height="23" /></a></td>
	            <td>
			<a href="deletejobs.php?jb_opening_id=<?php echo $row["jb_opening_id"];?>"
			onclick ="return confirm('Are you sure? Want to delete this Record')";><img src="images/trash.gif" width="28" height="22" /></a></td>
  </tr>
  <?php
  }
  ?>
